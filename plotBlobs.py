...
# Quit plotBlobs if there are more blobs or blobs groups than max value
# This is to prevent wasted computational time on noise-dominated images
if len(blobs) > max_blobs or len(groups) > max_blob_groups:
    quit()
